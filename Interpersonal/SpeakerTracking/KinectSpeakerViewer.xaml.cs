namespace SpeakerTracking
{
    ...
    /// </summary>
    public partial class KinectSpeakerViewer : KinectViewer
    {
        private ISpeakerTracker speakerTracker;

        #region Skeleton Tracking Dependency Properties 
        public static readonly DependencyProperty ShowBonesProperty =
            DependencyProperty.Register(
                "ShowBones",
                typeof(bool),
                typeof(KinectSpeakerViewer),
        ...
        public KinectSpeakerViewer()
        {
            ...
            {
                skeletonCenterPoint2D.Add(new Point());
            }
        ...
        {
            // try to find the position that matches the speaker angle
            for(int i = 0 ; i < skeletonCenterPoint2D.Count ; i++)
            {
            }
           
        }

        #region Skeleton Tracking Properties
        ...
        private void KinectAllFramesReady(object sender, AllFramesReadyEventArgs e)
        {
            ...
            if (haveSkeletonData)
            {
                ...
                for (int i = 0; i < this.skeletonData.Length && i < this.skeletonCanvases.Count; i++)
                {
                    ...
                    skeletonCenterPoint2D[i] = centerPoint;

                    // update center position for all skeletons
                }
            }
        }

        private void KinectSpeakerViewer_OnLoaded(object sender, RoutedEventArgs e)
        {      
            ...
            for (int i = 0; i < SkeletonCount; i++)
            {
                ...
                this.speakerCanvasPanel.Children.Add(skeletonCanvas);
            }
